...
*/
var scores, roundScore, activePlayer, gamePlaying, previousDice, previousDice2, totalDice;
init();
...
document.querySelector(".btn-roll").addEventListener("click", function () {
    ...
    if ((previousDice === 6 && dice === 6) || (previousDice2 === 6 && dice2 === 6) || totalDice === 12) {
...
document.querySelector('.btn-hold').addEventListener("click", function () {
    ...
    if (!winningScoreDOM.value) {
        winningScoreDOM.value = 100;
    }

    if (scores[activePlayer] >= winningScoreDOM.value) {
        gamePlaying = false;
